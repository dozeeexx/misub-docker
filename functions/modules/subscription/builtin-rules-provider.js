...
export const POLICY_GROUPS = {
    ...
    STD: (proxies) => {
        ...
        return [
            ...
            { name: FALLBACK_GROUP, type: 'fallback', proxies: proxyNames },
            { name: MANUAL_SELECT_GROUP, type: 'select', proxies: proxyNames },
            { name: '🤖 智能 AI', type: 'select', proxies: [AUTO_SELECT_GROUP, FALLBACK_GROUP, MANUAL_SELECT_GROUP, 'DIRECT'] },
            { name: '🎬 视频广告', type: 'select', proxies: ['REJECT', 'DIRECT'] },
            { name: '🎥 流媒体', type: 'select', proxies: [AUTO_SELECT_GROUP, FALLBACK_GROUP, MANUAL_SELECT_GROUP, 'DIRECT'] },
            ...
            { name: '📲 Telegram', type: 'select', proxies: [AUTO_SELECT_GROUP, FALLBACK_GROUP, MANUAL_SELECT_GROUP, 'DIRECT'] }
        ];
    },
    // 完整配置：细化分类
    FULL: (proxies) => {
        ...
        return [
            ...
            { name: 'Ⓜ️ Microsoft', type: 'select', proxies: ['DIRECT', AUTO_SELECT_GROUP, MANUAL_SELECT_GROUP] },
            { name: '📲 Telegram', type: 'select', proxies: [AUTO_SELECT_GROUP, FALLBACK_GROUP, MANUAL_SELECT_GROUP, 'DIRECT'] },
            { name: '🎧 Spotify', type: 'select', proxies: [AUTO_SELECT_GROUP, FALLBACK_GROUP, MANUAL_SELECT_GROUP, 'DIRECT'] },
    ...
    RELAY: (proxies) => {
        ...
        return [
            { name: DEFAULT_RELAY_GROUP, type: 'select', proxies: ['🔗 链式代理', AUTO_SELECT_GROUP, MANUAL_SELECT_GROUP, '🚀 常用节点', 'DIRECT'] },
            ...
            { name: '🚀 常用节点', type: 'select', proxies: [AUTO_SELECT_GROUP, FALLBACK_GROUP, MANUAL_SELECT_GROUP, 'DIRECT'] },
            { name: AUTO_SELECT_GROUP, type: 'url-test', proxies: proxyNames },
            { name: FALLBACK_GROUP, type: 'fallback', proxies: proxyNames },
            { name: MANUAL_SELECT_GROUP, type: 'select', proxies: proxyNames },
            { name: '🎬 视频广告', type: 'select', proxies: ['REJECT', 'DIRECT'] },
            { name: '🎥 流媒体', type: 'select', proxies: ['🚀 常用节点', AUTO_SELECT_GROUP, MANUAL_SELECT_GROUP, 'DIRECT'] },
            { name: '🤖 智能 AI', type: 'select', proxies: ['🔗 链式代理', '🚀 常用节点', AUTO_SELECT_GROUP, MANUAL_SELECT_GROUP, 'DIRECT'] },
